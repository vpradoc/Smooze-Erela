...
exports.run = (client, message, args) => {
  Guild.findOne({ _id: message.guild.id }, async function (err, server) {
    ...
    if(!message.member.hasPermission("MANAGE_GUILD")) return message.channel.send(`${Emojis.Errado} - ${message.author}, você precisa da permissão \`MANAGE_GUILD\` para executar o comando!`)
