  ...
  try {
    ...
    const SERVERINFO = new Discord.MessageEmbed()
      ...
      .addFields(
        ...
        {
            name: `:loud_sound:  **Total de Canais** ( **${message.guild.channels.cache.size - message.guild.channels.cache.filter((x) => x.type == "category").size}** )`,
            value: channels,
            inline: false,
          },
          {
    ...
    console.log(`Erro ao executar o comando s.serverinfo [${err}]`);
  }
};
...
exports.help = {
  name: "serverinfo",
  aliases: ["sinfo", "si"],
  description: "Comando para saber informações do servidor!",
